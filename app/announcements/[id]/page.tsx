          ...
          >
            ...
            <div className="flex gap-3">
              <button
                ...
                className="bg-accent hover:opacity-90 text-white px-8 py-3 rounded-xl font-bold uppercase text-[10px] tracking-widest transition-all"
              >
                {isProcessing
                  ? "Processing..."
                  : editingId
              ...
              {editingId && (
                <button
                  type="button"
                  onClick={resetForm}
                  className="bg-text-sub/20 text-text-sub px-8 py-3 rounded-xl font-bold uppercase text-[10px] tracking-widest hover:bg-text-sub/30"
                >
                  Cancel
                </button>
              )}
        ...
        <div className="space-y-8">
          {loading ? (
            ...
            announcements.map((item) => (
              <div
                key={item._id}
                className="bg-card/50 border border-card-border rounded-2xl overflow-hidden shadow-lg hover:shadow-xl transition-all group"
              >
                {item.imageUrl && (
                  <img
                    src={item.imageUrl}
